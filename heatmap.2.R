...
D.cls.r <- dist(BC0.cls)
D.cls.c <- dist(t(BC0.cls))
...
#!add.expr
#!breaks
symbreaks = FALSE # min(x < 0, na.rm = TRUE) || scale != "none"
#col = "heat.colors"
#!colsep
#!rowsep
sepcolor = "white"
...
#!ColSideColors
#!RowSideColors
nr<-dim(x)[1]; cexRow = 0.2 + 1/log10(nr)
nc<-dim(x)[2]; cexCol = 0.2 + 1/log10(nc)
labRow = NULL
labCol = NULL 
key = TRUE
keysize = 1.5
